...
graph TB
    ...
    subgraph "3D Systems - Hero Scene"
        ...
        Cruisers[Battlecruiser.jsx x3<br>44 lines each<br>Auto-fire 300-800ms]
    ...
    subgraph "3D Systems - Quantum Core"
        ...
        Rings[Torus Rings x5<br>radii 3.0 to 4.6]
        Particles[Points x2500<br>Cyan particles]
        Beams[EnergyBeams x20]
...
graph TB
    subgraph "Z-Index Layer 9999 (Highest)"
        TL[Corner TL<br>40x40px bracket]
        TR[Corner TR]
        BL[Corner BL]
        BR[Corner BR]
    end
    ...
    subgraph "Z-Index 9997"
        Vignette[Global Vignette<br>Radial darkening<br>center to 85% dark]
    end
...
graph LR
    subgraph "Battlecruiser Component"
        ...
        subgraph "Geometry"
            Hull[BoxGeometry<br>2.2 x 0.28 x 0.7]
            Bridge[BoxGeometry<br>0.35 cubed]
            Nose[ConeGeometry<br>0.14 x 0.7, 6 segs]
            Engines[CylinderGeometry x2<br>0.1/0.13 x 1.1, 8 segs]
            Winglets[BoxGeometry x2<br>0.4 x 0.04 x 0.6]
            Antennae[CylinderGeometry x2<br>0.02 x 0.02 x 0.3, 4 segs]
        end
        ...
        subgraph "Animation (useFrame)"
            DriftX["position.x +=<br>sin(t x 0.3) x 0.25"]
            DriftY["position.y +=<br>sin(t x 0.5) x 0.18"]
            RotZ["rotation.z +=<br>sin(t x 0.2) x 0.03"]
            RotX["rotation.x +=<br>sin(t x 0.4) x 0.04"]
        end
...
graph TD
    subgraph "QuantumCore.jsx (134 lines)"
        ...
        subgraph "Core Objects"
            ...
            CoreCube[Mesh<br>BoxGeometry 4x4x4<br>MeshPhysicalMaterial<br>transmission:1<br>roughness:0<br>metalness:0.8]
            
            InnerCube["Mesh<br>BoxGeometry 1.2 cubed<br>MeshBasicMaterial #ff66ff<br>counter-rotates +/-0.01"]
        end
        
        subgraph "Ring System"
            Ring1[TorusGeometry r:3.0<br>thickness 0.02<br>16x100 segs<br>violet]
        ...
        subgraph "Particle System"
            Particles[Points<br>2500 particles<br>BufferGeometry<br>80 cubed volume range]
            ParticleMat[PointsMaterial<br>#7dd3fc size 0.03<br>sizeAttenuation true]
        end
        
        subgraph "Energy Beams"
            Beams[Mesh x20<br>CylinderGeometry<br>0.01 x 0.01 x 20, 6 segs]
            BeamMat[MeshBasicMaterial<br>#f97316 opacity 0.3]
        end
        
        subgraph "Helpers"
            Grid[GridHelper<br>100x100<br>#8b5cf6 / #222<br>y:-5]
        end
        
        subgraph "Camera Control"
            CameraQ[Camera<br>position 0,0,14<br>FOV 60 deg]
...
flowchart TB
    ...
    subgraph "CSS Animation"
        MatrixFall["Keyframe: matrixFall<br>translateY -100% to 100vh"]
    ...
    subgraph "Quote Examples"
        Q1["Total crew, battle stations"]
        Q2["Quantum reactor stable"]
        Q3["Hostile reaction detected"]
        Q4["Shields at maximum"]
        Q5["Redstar Division ready"]
    end
...
graph TB
    subgraph "src/App.css (1067 lines)"
        ...
        subgraph "Atmospheric Layers (lines 871-980)"
            ...
            GlobalVignette[.global-vignette<br>radial darkening<br>center to 85% dark<br>z-index 9997]
        end
        ...
        subgraph "Component Styles"
            ...
            CinemaStyles["CinematicGrid<br>5-column to 2-col @700px<br>flicker border"]
            ...
            CornerStyles[Corner brackets<br>40x40px<br>z-index 9999]
        end
    end
...
graph LR
    ...
    subgraph "Optimization Opportunities"
        ...
        ReduceParticles[Particles 2500 to 1000<br>Save GPU]
